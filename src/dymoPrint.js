...
(function () {
  ...
  var getOwnerDocument = function (node) {
    ...
    return /** @type {!Document} */ (node.nodeType == NodeType.DOCUMENT
      ? node
  ...
  function onload() {
    ...
    var printerSettingsButton = document.getElementById(
    ...
    var clearPrinterUriButton = document.getElementById(
      "clearPrinterUriButton"
    );
    ...
    function updatePrinters() {
      ...
      printerSettingsDiv.style.display =
        printers.length == 0 ? "block" : "none";
    }
    ...
    function loadSettings() {
      ...
      for (var i = 0; i < settings.printerUris.length; ++i) {
        ...
        dymo.label.framework.addPrinterUri(
          printerUri,
          "",
          updatePrinters,
          function () {
    ...
    printerSettingsButton.onclick = function () {
      ...
      else printerSettingsDiv.style.display = "none";
    };
    ...
    printButton.onclick = function () {
      try {
        ...
        if (!label)
          throw new Error(
            "Label is not loaded. Wait until is loaded or reload the page"
          );
        ...
        var printJob = label.printAndPollStatus(
          printer.name,
          null,
          labelSet.toString(),
          function (printJob, printJobStatus) {
            // output status
